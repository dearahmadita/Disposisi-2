...
class Masuk_model extends CI_Model
{
    ...
    public function editData()
    {
        ...
        //  $this->session->set_flashdata("success","Data surat Berhasil DiUpdate");
        //}
    }
    ...
    public function delete($id)
    {
        ...
        if($this->db->affected_rows()>0){
            $this->session->set_flashdata("success", "Data surat Berhasil DiDelete");
        }
    }
    ...
    private function deleteImage($id)
    {
        ...
        if($surat->image != "no_image.jpg"){
            ...
            return array_map('unlink', glob(FCPATH."assets/photo/surat_masuk/$file_name.*"));
        }
    }
}
?>
                                ...
                                $no=1;
                                    foreach($surat as $suratdata) {
                                        echo    "<tr>
                                                    ...
                                                    <td>
                                                    <div>
                                                    <a href=".base_url('surat_ajuan/delete/'/$suratdata->id)." class='btn btn-sm btn-danger' onclick='return confirm(\"Ingin menghapus data user ini?\");'><i class='fas fa-trash'></i> Hapus</a>
                                                    </div>
                                                    </td>
                                                </tr>";
                                                $no++;

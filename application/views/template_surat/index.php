                            ...
                            $no=1;
                                foreach($template as $suratdata){
                                    echo    "<tr>
                                                ...
                                                <a href=".base_url('templatesurat/delete/'.$suratdata->id)." class='btn btn-sm btn-danger' onclick='return confirm(\"Ingin menghapus dtaa user ini?\");'><i class='fas fa-trash'></i> Hapus</a>
